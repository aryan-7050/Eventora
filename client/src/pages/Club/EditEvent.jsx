    ...
    return (
        <div className="create-event-container animate-fade-in">
            <div className="dashboard-header" style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
                <button
                    onClick={() => navigate('/club/event-status')}
                ...
                <div>
                    <h1 className="dashboard-title">Edit & Repost Event</h1>
                    <p className="dashboard-subtitle">Update your event details and resubmit for administrative approval.</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="event-form glass-panel">
                ...
                <div className="form-actions">
                    <button type="button" className="btn btn-secondary" onClick={() => navigate('/club/event-status')}>Cancel</button>
                    <button type="submit" className="btn btn-club create-btn" disabled={submitting}>
                        {submitting ? 'Updating...' : 'Update & Repost Event'}
                    </button>
                </div>
            </form>
        </div>
